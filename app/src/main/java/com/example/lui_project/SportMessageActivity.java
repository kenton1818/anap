...
public class SportMessageActivity extends BaseActivity   implements View.OnClickListener{
    ...
    protected void setActivityTitle() {
        initTitle();
        setTitle(this.getString(R.string.sportmsg_title), this);
    ...
    protected void setViewsFunction() {
        ...
        keepfit_scores.setText(String.valueOf(scores) +this.getString(R.string.sportmsg_min));
        //data list
        if (counts > 0){
            ...
            Toast.makeText(this,this.getString(R.string.sportmsg_Toast1), Toast.LENGTH_SHORT).show();
        }
        cursor.close();
    }
