...
import mrkj.library.R.color;
import mrkj.library.R.drawable;
import mrkj.library.wheelview.adapter.WheelViewAdapter;
  ...
  extends View
{
  ...
  private int getDesiredHeight(LinearLayout layout)
  {
    ...
    int desired = itemHeight * visibleItems - itemHeight * 0 / 50;
  ...
  private int calculateLayoutWidth(int widthSize, int mode)
  {
    ...
    itemsLayout.setLayoutParams(new ViewGroup.LayoutParams(-2, -2));
    itemsLayout.measure(View.MeasureSpec.makeMeasureSpec(widthSize, 0), View.MeasureSpec.makeMeasureSpec(0, 0));
    ...
    itemsLayout.measure(View.MeasureSpec.makeMeasureSpec(width - 20, 1073741824), View.MeasureSpec.makeMeasureSpec(0, 0));
  ...
  private void drawItems(Canvas canvas)
  {
    ...
    canvas.translate(10.0F, -top + scrollingOffset);
  ...
  private void drawCenterRect(Canvas canvas)
  {
    ...
    canvas.drawLine(0.0F, center - offset, getWidth(), center - offset, paint);
  ...
  private ItemsRange getItemsRange()
  {
    ...
    if (scrollingOffset != 0) {
      ...
      first -= emptyItems;
      count = (int)(count + Math.asin(emptyItems));
    }
